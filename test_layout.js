...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '/home/sliu/Documents/Gridea/static/test_layout.data';
      var REMOTE_PACKAGE_BASE = 'test_layout.data';
...
Module['FS_createPath']('/data', 'arkit_verts', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_/home/sliu/Documents/Gridea/static/test_layout.data');

      };
      Module['addRunDependency']('datafile_/home/sliu/Documents/Gridea/static/test_layout.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 123313, "filename": "/data/arkit_verts/AR_mean.obj"}], "remote_package_size": 123313, "package_uuid": "32d5d9d1-efe2-40c3-8afb-2eb659ad3385"});
...
var wasmBinaryFile = 'test_layout.wasm';
...
var ASM_CONSTS = {
  1382: function($0, $1, $2) {let d = new DOMParser().parseFromString(UTF8ToString($2), 'text/html'); let div = d.body.firstChild; window.widgets[$0] = div; if ($1 == 0) { document.body.appendChild(div); window.closeable[$0] = div; } else { window.widgets[$1].appendChild(div); }},  
 1640: function($0, $1) {window.widgets[$0].appendChild(window.widgets[$1]);},  
 1737: function($0, $1) {window.widgets[$1].appendChild(window.widgets[$0]);},  
 1793: function($0, $1) {window.widgets[$0].setAttribute("parent", "" + $1); let d = document.getElementById($0 + "_close_btn"); if (d) { window.widgets[$0].removeChild(d); if ($0 in window.closeable) { delete window.closeable[$0]; } }},  
 2011: function($0) {if ($0 in window.closeable) { delete window.closeable[$0]; document.body.removeChild(window.widgets[$0]); }},  
 4958: function($0, $1) {var layout = document.createElement('div'); layout.style = 'display: grid; grid-gap: 10px; padding: 10px;'; if ($1 == 0) { document.body.appendChild(layout); } else { window.widgets[$1].appendChild(layout); } window.widgets[$0] = layout;},  
 5203: function($0) {window.widgets[$0].innerHTML = "";},  
 5248: function($0, $1) {console.log(window.widgets[$0]); console.log(window.widgets[$1]); window.widgets[$0].appendChild(window.widgets[$1]);},  
 5376: function($0, $1, $2, $3) {var div = document.createElement('div'); div.style['grid-area'] = UTF8ToString($1); div.setAttribute("name", "blank_" + $2, $3); window.widgets[$0].appendChild(div);},  
 5554: function($0, $1) {window.widgets[$0].style["grid-template-areas"] = UTF8ToString($1);},  
 6606: function($0, $1) {var text = document.createElement('pre'); text.style = 'white-space: pre-wrap; word-break: keep-all;'; text.innerHTML = UTF8ToString($1); window.widgets[$0 + "_text"] = text; window.widgets[$0].appendChild(text);},  
 6856: function($0) {window.widgets[$0].setAttribute("name", "frame_" + $0);}
};

function _emscripten_asm_const_iii(code, sigPtr, argbuf) {
  var args = readAsmConstArgs(sigPtr, argbuf);
  return ASM_CONSTS[code].apply(null, args);
}function openFileDialog(ptr,len,scope,dialog){ var input = document.createElement('input'); input.type = "file"; input.id = 'input_file_dialog'; input.style = "display:none"; document.body.appendChild(input); document.getElementById('input_file_dialog').click(); input.addEventListener( "change", function(event) { var file = input.files[0]; var name = file.name; document.body.removeChild(input); stringToUTF8(name, ptr, len); var reader = new FileReader(); reader.readAsArrayBuffer(file); reader.onload = function(evt) { var n_bytes = evt.target.result.byteLength; var emcc_ptr = window.instance._malloc(n_bytes); var heap = new Uint8Array(window.instance.HEAPU8.buffer, emcc_ptr, n_bytes); heap.set(new Uint8Array(evt.target.result)); window.instance.flush_file(name, emcc_ptr, n_bytes); window.instance._free(emcc_ptr); window.instance.wake_up(scope, dialog); } }); }



// STATICTOP = STATIC_BASE + 29552;
...
// {{PRE_LIBRARY}}
  ...
  function _emscripten_fiber_init_from_current_context(fiber, asyncStack, asyncStackSize) {
      HEAP32[((fiber)>>2)]=STACK_BASE;
      HEAP32[(((fiber)+(4))>>2)]=STACK_MAX;
      HEAP32[(((fiber)+(12))>>2)]=0;
  ...
  var Fibers={nextFiber:0,trampolineRunning:false,trampoline:function() {
        ...
        STACK_BASE = HEAP32[((newFiber)>>2)];
        STACK_MAX =  HEAP32[(((newFiber)+(4))>>2)];
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_throw": ___cxa_throw, "__handle_stack_overflow": ___handle_stack_overflow, "__lock": ___lock, "__map_file": ___map_file, "__syscall221": ___syscall221, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall91": ___syscall91, "__unlock": ___unlock, "_embind_register_bool": __embind_register_bool, "_embind_register_class": __embind_register_class, "_embind_register_class_class_function": __embind_register_class_class_function, "_embind_register_class_constructor": __embind_register_class_constructor, "_embind_register_emval": __embind_register_emval, "_embind_register_float": __embind_register_float, "_embind_register_function": __embind_register_function, "_embind_register_integer": __embind_register_integer, "_embind_register_memory_view": __embind_register_memory_view, "_embind_register_std_string": __embind_register_std_string, "_embind_register_std_wstring": __embind_register_std_wstring, "_embind_register_void": __embind_register_void, "abort": _abort, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_fiber_init": _emscripten_fiber_init, "emscripten_fiber_init_from_current_context": _emscripten_fiber_init_from_current_context, "emscripten_fiber_swap": _emscripten_fiber_swap, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "openFileDialog": openFileDialog, "setTempRet0": _setTempRet0, "strftime_l": _strftime_l, "table": wasmTable };
